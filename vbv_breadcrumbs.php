<?php
/*
Plugin Name: Vbv Breadcrumbs
Description: Breadcrumbs. Что бы отобразить вызовите функцию breadcrumbs(). Для настроект редактируйте файл плагина, в дальнешем планируется настройка из админки.
Version: 1.0
Author: Dimox, co-author Vicos
Author URI: #
*/
// Активация и деактивация плагина
include_once dirname( __FILE__ ) . '/class.BreadcrumbsAction.php';
